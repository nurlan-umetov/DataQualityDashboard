...
RUN R -e "remotes::install_github('OHDSI/DatabaseConnector', ref = 'main', force = TRUE, dependencies = FALSE, upgrade = 'always')"
RUN R -e "remotes::install_github('https://github.com/OHDSI/DataQualityDashboard/R', ref = 'main', force = TRUE, dependencies = FALSE, upgrade = 'always')"
RUN R -e "remotes::install_github('OHDSI/DataQualityDashboard', ref = 'main', force = TRUE, dependencies = FALSE, upgrade = 'always')"
