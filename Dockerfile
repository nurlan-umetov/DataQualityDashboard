...
RUN R -e "remotes::install_github('OHDSI/DatabaseConnector'), ref = 'master', force = TRUE, dependencies = FALSE, upgrade = 'always'"
RUN R -e "remotes::install_github('https://github.com/OHDSI/DataQualityDashboard/R', ref = 'master', force = TRUE, dependencies = FALSE, upgrade = 'always')"
RUN R -e "remotes::install_github('OHDSI/DataQualityDashboard', ref = 'master', force = TRUE, dependencies = FALSE, upgrade = 'always')"
